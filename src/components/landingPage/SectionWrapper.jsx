...
const SectionWrapper = ({
  ...
  return (
    ...
    <div
      className={`min-h-screen ${styles.section} ${banner} ${reverse ? styles.bgWhite : styles.bgPrimary
        }`}
    >
      ...
      >
        ...
        `}
          ...
          <div className="flex justify-between">
            {showBtn && (
              <Button assetUrl={assets.expo} Link="deployed nft marketplace rn" text1={"View it on"}
                text2={"Expo Store"} />
